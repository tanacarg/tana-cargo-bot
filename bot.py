...
SUPPORT_USERNAME = "@tanacargosupport"
SUPPORT_URL = "https://t.me/tanacargosupport"
...
def main():
    ...
    application.add_handler(
        CommandHandler("myprofile", profile)
    )
    application.add_handler(
    ...
    master_conversation = ConversationHandler(
        ...
        entry_points=[
            ...
            # IMPORTANT: These menu buttons must also be ConversationHandler
            # entry points. Without these entries, the buttons are ignored
            # whenever no conversation is active, even though menu_router()
    ...
    # One process: health server + Telegram polling.
    # Do NOT use: python -m http.server $PORT & python bot.py
